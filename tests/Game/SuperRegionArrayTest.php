...
class SuperRegionArrayTest extends TestCase
{
	 ...
	 * @covers \Prokki\Warlight2BotTemplate\Game\SuperRegionArray::addSuperRegion()
	 */
	public function testGetIds()
	{
		...
		$super_regions->addSuperRegion(new SuperRegion(4711, 20));
		$super_regions->addSuperRegion(new SuperRegion(815, 13));
	 ...
	 * @covers \Prokki\Warlight2BotTemplate\Game\SuperRegionArray::hasSuperRegion()
	 */
	public function testGet()
	{
		...
		$super_regions->addSuperRegion($super_region_1);
		$super_regions->addSuperRegion($super_region_2);

		// super region with ID 815 exists
		self::assertTrue($super_regions->hasSuperRegion(815));
